 ...
 * Description:  Reading a CSV file, getting servos positions, and playing the CSV file.
...
static WbDeviceTag joint[25];     /* all the servos */
...
int main(int argc, char *argv[])
{
    ...
    int pulse[] =
        ...
        -209, -209, 209, -209, 209, 0, 209, 209, -209, -209, 0, 0, 0
    };
    ...
    for (i = 0; i < 25; i++) {
        ...
        wb_servo_enable_position(joint[i], control_step);
    }
    ...
    sscanf(l,
          ...
          &sampling,
          &tempMotor[rleg_joint_1],
          &tempMotor[rleg_joint_2],
          &tempMotor[rleg_joint_3],
          &tempMotor[rleg_joint_4],
          &tempMotor[rleg_joint_5],
          &tempMotor[rleg_joint_6],
          &tempMotor[rarm_joint_1],
          &tempMotor[rarm_joint_2],
          &tempMotor[rarm_joint_3],
          &tempMotor[rarm_joint_4],
          &tempMotor[lleg_joint_1],
          &tempMotor[lleg_joint_2],
          &tempMotor[lleg_joint_3],
          &tempMotor[lleg_joint_4],
          &tempMotor[lleg_joint_5],
          &tempMotor[lleg_joint_6],
          &tempMotor[larm_joint_1],
          &tempMotor[larm_joint_2],
          &tempMotor[larm_joint_3],
          &tempMotor[larm_joint_4],
    ...
    for (i = 0; i < 25; i++) {
        next_position[i] = wb_servo_get_position(joint[i]);
    }
        ...
        if (!file_ended) {      /* else don't need to run, just a step */
            ...
            if (file_ended == 0) {
                ...
                sscanf(l,
                      ...
                      " %d, %d, %d, %d, %d, %d, %d, %d, %d, %d,"
                      " %d, %d, %*c ,%*c ,%*c,%*c ",
                      &pos_from_cvs[rleg_joint_1],
                      &pos_from_cvs[rleg_joint_2],
                      &pos_from_cvs[rleg_joint_3],
                      &pos_from_cvs[rleg_joint_4],
                      &pos_from_cvs[rleg_joint_5],
                      &pos_from_cvs[rleg_joint_6],
                      &pos_from_cvs[rarm_joint_1],
                      &pos_from_cvs[rarm_joint_2],
                      &pos_from_cvs[rarm_joint_3],
                      &pos_from_cvs[rarm_joint_4],
                      &pos_from_cvs[lleg_joint_1],
                      &pos_from_cvs[lleg_joint_2],
                      &pos_from_cvs[lleg_joint_3],
                      &pos_from_cvs[lleg_joint_4],
                      &pos_from_cvs[lleg_joint_5],
                      &pos_from_cvs[lleg_joint_6],
                      &pos_from_cvs[larm_joint_1],
                      &pos_from_cvs[larm_joint_2],
                      &pos_from_cvs[larm_joint_3],
                      &pos_from_cvs[larm_joint_4],
                      &pos_from_cvs[body_joint_1]);
                for (i = 0; i < 23; i++) {  /* convert to radian */
                    next_position[i] =
                        pos_from_cvs[i] * (M_PI / 180.0) / pulse[i];
                }
            }

            /* Now assign the new angle values. */
            wb_servo_set_position(joint[body_joint_1],
                               next_position[body_joint_1]);
            wb_servo_set_position(joint[lleg_joint_1],
                               next_position[lleg_joint_1]);
            wb_servo_set_position(joint[lleg_joint_2],
                               next_position[lleg_joint_2]);
            wb_servo_set_position(joint[lleg_joint_3],
                               next_position[lleg_joint_3]);
            wb_servo_set_position(joint[lleg_joint_4],
                               next_position[lleg_joint_4]);
            wb_servo_set_position(joint[lleg_joint_5],
                               next_position[lleg_joint_5]);
            wb_servo_set_position(joint[lleg_joint_6],
                               next_position[lleg_joint_6]);
            wb_servo_set_position(joint[rleg_joint_1],
                               next_position[rleg_joint_1]);
            wb_servo_set_position(joint[rleg_joint_2],
                               next_position[rleg_joint_2]);
            wb_servo_set_position(joint[rleg_joint_3],
                               next_position[rleg_joint_3]);
            wb_servo_set_position(joint[rleg_joint_4],
                               next_position[rleg_joint_4]);
            wb_servo_set_position(joint[rleg_joint_5],
                               next_position[rleg_joint_5]);
            wb_servo_set_position(joint[rleg_joint_6],
                               next_position[rleg_joint_6]);
            wb_servo_set_position(joint[larm_joint_1],
                               next_position[larm_joint_1]);
            wb_servo_set_position(joint[larm_joint_2],
                               next_position[larm_joint_2]);
            wb_servo_set_position(joint[larm_joint_3],
                               next_position[larm_joint_3]);
            wb_servo_set_position(joint[larm_joint_4],
                               next_position[larm_joint_4]);
            wb_servo_set_position(joint[rarm_joint_1],
                               next_position[rarm_joint_1]);
            wb_servo_set_position(joint[rarm_joint_2],
                               next_position[rarm_joint_2]);
            wb_servo_set_position(joint[rarm_joint_3],
                               next_position[rarm_joint_3]);
            wb_servo_set_position(joint[rarm_joint_4],
