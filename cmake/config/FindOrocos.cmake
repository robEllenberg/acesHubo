...
IF ( CMAKE_PKGCONFIG_EXECUTABLE AND NOT SKIP_BUILD)
	...
	IF ( OROCOS_TARGET STREQUAL "${FLAVOR_TARGET}")
	  ...
	  PKGCONFIG( "orocos-ocl-${FLAVOR_TARGET} >= 1.0.0" OROCOS_OCL OROCOS_OCL_INCLUDE_DIRS OROCOS_OCL_DEFINES OROCOS_OCL_LINK_DIRS OROCOS_OCL_LIBS )
          MESSAGE("   Includes in: ${OROCOS_OCL_INCLUDE_DIRS}")
          MESSAGE("   Libraries in: ${OROCOS_OCL_LINK_DIRS}")
          MESSAGE("   Libraries: ${OROCOS_OCL_LIBS}")
          MESSAGE("   Defines: ${OROCOS_OCL_DEFINES}")
	  
	  INCLUDE_DIRECTORIES( ${OROCOS_RTT_INCLUDE_DIRS} )
          LINK_DIRECTORIES( ${OROCOS_RTT_LINK_DIRS} )
	  ADD_DEFINITIONS( ${OROCOS_RTT_DEFINES} )

	  INCLUDE_DIRECTORIES( ${OROCOS_OCL_INCLUDE_DIRS} )
          LINK_DIRECTORIES( ${OROCOS_OCL_LINK_DIRS} )
	  ADD_DEFINITIONS( ${OROCOS_OCL_DEFINES} )
