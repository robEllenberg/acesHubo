...
#ifdef MagellanDEBUG
 cprintf(stderr, "Magellan: xdrvlib.c \n" );
 cprintf(stderr, "MagellanMotionEvent = %d \n", MagellanMotionEvent );
 cprintf(stderr, "MagellanButtonPressEvent = %d \n", MagellanButtonPressEvent );
 cprintf(stderr, "MagellanButtonReleaseEvent = %d \n", MagellanButtonReleaseEvent );
 cprintf(stderr, "MagellanCommandEvent = %d \n", MagellanCommandEvent );
 cprintf(stderr, "\n");
#endif
...
#ifdef MagellanDEBUG
 cprintf(stderr, "Magellan: xdrvlib.c \n" );
 cprintf(stderr, "Magellan Display = %s \n", XDisplayName( (char *)NULL ) );
 cprintf(stderr, "Magellan Driver Window = %08X \n", MagellanWindow );
 cprintf(stderr, "Magellan Application Window = %08X \n", window );
 cprintf(stderr, "\n");
#endif
...
#ifdef MagellanDEBUG 
 cprintf(stderr, "Magellan: xdrvlib.c \n" );
 cprintf(stderr, "Magellan Root Window Number: %08X \n\n", root );
#endif
...
#ifdef MagellanDEBUG
       cprintf(stderr, "Magellan Application Sensitivity: %lf \n\n", Sensitivity );
#endif
...
#ifdef MagellanDEBUG
       cprintf(stderr, "Magellan Send Command Message: %08X \n\n", window );
#endif
