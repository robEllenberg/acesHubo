...
export LD_LIBRARY_PATH=/usr/local/webots/lib/:/opt/ros/cturtle/stacks/orocos_toolchain_ros/rtt/install/lib:/opt/ros/cturtle/stacks/orocos_toolchain_ros/rtt/install/lib/orocos/plugins:$ACES_ROOT/build/aces/lib:$LD_LIBRARY_PATH
